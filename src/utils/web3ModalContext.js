...
const Web3Provider = ({ children }) => {
    ...
    const w3m = new Web3Modal({
      ...
      providerOptions: {
        ...
        walletconnect: {
          ...
          options: {
            infuraId: '20417308dad64ba3bff6b1c9434c417f'
          }
        },
        coinbasewallet: {
  ...
  const clearCachedProvider = async () => {
    if (!web3Modal) return
  ...
  return (
    <Web3Context.Provider value={{ ...web3Resources, connect, clearCachedProvider }}>
      {children}
